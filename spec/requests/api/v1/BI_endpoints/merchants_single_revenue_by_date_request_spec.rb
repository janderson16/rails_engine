...
describe ".revenue_by_date" do
  it "returns revenue for a single merchant on specific date" do
    ...
    item_2 = Item.create!(name: "thing2", unit_price: 201, merchant_id: merch_1.id)
    invoice_1 = Invoice.create!(merchant_id: merch_1.id, customer_id: customer.id, created_at: "2012-03-16T03:04:05.000Z")
    invoice_2 = Invoice.create!(merchant_id: merch_1.id, customer_id: customer.id, created_at: "2012-03-16T03:03:07.000Z")
    invoice_3 = Invoice.create!(merchant_id: merch_1.id, customer_id: customer.id, created_at: "2012-03-18T03:04:10.000Z")
