...
describe ".most_revenue" do
  it "ranks merchants by total items sold" do
    ...
    invoice_item_3 = InvoiceItem.create!(invoice_id: invoice_2.id, quantity: 7, item_id: item_3.id, unit_price: item_3.unit_price)
    ...
    expect(merchants.first['name']).to eq("Merchant 2")
  end
end
